...
👉 INTRO:
{topic} ki kahani yahan se shuru hoti hai...

👉 MAIN STORY:
Is topic par ek engaging aur cinematic story banti hai jo user ke input par based hai.

👉 ENDING:
Story ka end impactful aur memorable hota hai.

--------------------------------

🚀 Generated by FlowAI Creator Bot
"""
